  ...
  generateDoc() {
    ...
    if (editor) {
      ...
      if(docGenerated){
        ...
        let configs  = atom.config.get('doco')
        ...
        console.log(configs)
        let commandtoRun = docoPath + " '" + JSON.stringify(configs) + "' '" + packageString + "' '" + classString + "' '" + funcString + "'"
